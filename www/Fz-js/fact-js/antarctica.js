...
var mySwiper = myApp.swiper('.swiper-container', {
 ...
 $.get('fz-data/antarctica.txt',function(data){
   ...
   for(var i = arraytest-1  ; i >=0  ; i--){
        ...
        var example = 
                    `<div class='swiper-slide' id="${'antarctica_id_'+i}" data-fact ="${'antarctica_fact_'+i}"  data-favorite="false">` +
                            "<span>"+lines[i]+"</span>"+
                        "</div>";
...
mySwiper.on('slideChangeEnd',function(){ 
    ...
    if(localStorage!=null)
    {
        ...
        
        {
            ...
            if(localStorage.getItem(`${"antarctica_id_"+i}`)=="true")
            {
            $("#"+`${"antarctica_id_"+i}`).attr("data-favorite","true");
            slideChecker();
            }
        }
